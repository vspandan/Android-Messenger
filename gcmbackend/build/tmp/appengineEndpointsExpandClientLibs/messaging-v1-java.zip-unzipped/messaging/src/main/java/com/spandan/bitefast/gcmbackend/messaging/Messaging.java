...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public RemoveAddress removeAddress(java.lang.String id, java.lang.String phone) throws java.io.IOException {
    RemoveAddress result = new RemoveAddress(id, phone);
    initialize(result);
    return result;
  }
  ...
  public class RemoveAddress extends MessagingRequest<Void> {
    ...
    private static final String REST_PATH = "address/{id}/{phone}";
     ...
     * @since 1.13
     */
    protected RemoveAddress(java.lang.String id, java.lang.String phone) {
      super(Messaging.this, "POST", REST_PATH, null, Void.class);
    ...
    public RemoveAddress setPhone(java.lang.String phone) {
      this.phone = phone;
      return this;
    }
