...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public InsertUser insertUser(java.lang.String regId, java.lang.String phoneNum, java.lang.String name, java.lang.String email, java.lang.String addr, java.lang.String street, java.lang.String landmark, java.lang.String city, java.lang.Boolean isAdmin) throws java.io.IOException {
    InsertUser result = new InsertUser(regId, phoneNum, name, email, addr, street, landmark, city, isAdmin);
    initialize(result);
    return result;
  }
  ...
  public class InsertUser extends MessagingRequest<Void> {
    ...
    private static final String REST_PATH = "void/{regId}/{phoneNum}/{name}/{email}/{addr}/{street}/{landmark}/{city}/{isAdmin}";
     ...
     * @since 1.13
     */
    protected InsertUser(java.lang.String regId, java.lang.String phoneNum, java.lang.String name, java.lang.String email, java.lang.String addr, java.lang.String street, java.lang.String landmark, java.lang.String city, java.lang.Boolean isAdmin) {
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String phn) throws java.io.IOException {
    Register result = new Register(regId, phn);
    initialize(result);
    return result;
  }

  public class Register extends MessagingRequest<Void> {

    private static final String REST_PATH = "register/{regId}/{phn}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String phn) {
      super(Messaging.this, "POST", REST_PATH, null, Void.class);
      this.regId = com.google.api.client.util.Preconditions.checkNotNull(regId, "Required parameter regId must be specified.");
    ...
    public Register setPhn(java.lang.String phn) {
      this.phn = phn;
      return this;
    }
  ...
  /**
   * Create a request for the method "saveMessage".
   *
   * This request holds the parameters needed by the messaging server.  After setting any optional
   * parameters, call the {@link SaveMessage#execute()} method to invoke the remote operation.
   *
   * @param regId
   * @param from
   * @param to
   ...
   * @return the request
   */
  public SaveMessage saveMessage(java.lang.String regId, java.lang.String from, java.lang.String to, java.lang.String message) throws java.io.IOException {
    SaveMessage result = new SaveMessage(regId, from, to, message);
    initialize(result);
    return result;
  }

  public class SaveMessage extends MessagingRequest<Void> {

    private static final String REST_PATH = "saveMessage/{regId}/{from}/{to}/{message}";

    /**
     * Create a request for the method "saveMessage".
     *
     * This request holds the parameters needed by the the messaging server.  After setting any
     * optional parameters, call the {@link SaveMessage#execute()} method to invoke the remote
     * operation. <p> {@link
     * SaveMessage#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param regId
     * @param from
     ...
     * @since 1.13
     */
    protected SaveMessage(java.lang.String regId, java.lang.String from, java.lang.String to, java.lang.String message) {
      super(Messaging.this, "POST", REST_PATH, null, Void.class);
      this.regId = com.google.api.client.util.Preconditions.checkNotNull(regId, "Required parameter regId must be specified.");
    ...
    @Override
    public SaveMessage setAlt(java.lang.String alt) {
      return (SaveMessage) super.setAlt(alt);
    }

    @Override
    public SaveMessage setFields(java.lang.String fields) {
      return (SaveMessage) super.setFields(fields);
    }

    @Override
    public SaveMessage setKey(java.lang.String key) {
      return (SaveMessage) super.setKey(key);
    }

    @Override
    public SaveMessage setOauthToken(java.lang.String oauthToken) {
      return (SaveMessage) super.setOauthToken(oauthToken);
    }

    @Override
    public SaveMessage setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SaveMessage) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SaveMessage setQuotaUser(java.lang.String quotaUser) {
      return (SaveMessage) super.setQuotaUser(quotaUser);
    }

    @Override
    public SaveMessage setUserIp(java.lang.String userIp) {
      return (SaveMessage) super.setUserIp(userIp);
    }
    ...
    public SaveMessage setRegId(java.lang.String regId) {
      this.regId = regId;
      return this;
    }
    ...
    public SaveMessage setFrom(java.lang.String from) {
      this.from = from;
      return this;
    }
    ...
    public SaveMessage setTo(java.lang.String to) {
      this.to = to;
      return this;
    }
    ...
    public SaveMessage setMessage(java.lang.String message) {
      this.message = message;
      return this;
    }

    @Override
    public SaveMessage set(String parameterName, Object value) {
      return (SaveMessage) super.set(parameterName, value);
    }
  }
